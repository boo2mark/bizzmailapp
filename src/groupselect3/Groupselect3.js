// @flow
    ...
    export default class Groupselect3 extends React.PureComponent<ScreenProps<>> {
      state = {
        data: []
      };
    ...
    class Group extends React.PureComponent<GroupProps> {
    	...
    	veder = async(id) =>  {
            ...
            fetch("https://api.mybizzmail.com/v1/group/" + id,  {
              ...
              .then(response => {
                  console.log(response);
                 const groupd = response.id.toString();
        ...
        Actions.setting();
          ...
          Postuser = async() =>{
            ...
            await AsyncStorage.setItem("groupids3", id).then(
              () => AsyncStorage.getItem("groupids3")
